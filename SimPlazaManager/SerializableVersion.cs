...
public class SerializableVersion : ICloneable, IComparable
{
    ...
    public static SerializableVersion Parse(string version)
    {
    ...
    public object Clone()
    {
        SerializableVersion version1 = new()
        {
            major = this.major,
            minor = this.minor,
            build = this.build,
    ...
    public int CompareTo(object? version)
    {
        ...
        SerializableVersion version1 = (SerializableVersion)version;
    ...
    public string ToString(int fieldCount)
    {
        ...
        if (this.build == -1)
        {
            throw new ArgumentException($"ArgumentOutOfRange_Bounds_Lower_Upper {"0"},{"2"}", "fieldCount");
        }
        if (fieldCount == 3)
        {
        ...
        if (this.revision == -1)
        {
            throw new ArgumentException($"ArgumentOutOfRange_Bounds_Lower_Upper {"0"},{"3"}", "fieldCount");
        }
        if (fieldCount == 4)
        {
        ...
        throw new ArgumentException($"ArgumentOutOfRange_Bounds_Lower_Upper {"0"},{"4"}", "fieldCount");
    }
}
